...
func TestInitScaffold(t *testing.T) {
	...
	for _, rel := range []string{
		...
		".paseka/prompts/_partials/scout-intent-plan.md",
		".paseka/prompts/_partials/scout-intent-triage.md",
		".paseka/prompts/_partials/scout-intent-classify.md",
		".paseka/prompts/_partials/scout-emit-classify.md",
