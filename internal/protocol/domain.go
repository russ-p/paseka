...
func InsightKindForEventType(kind string) EventType {
	...
	case InsightRunSummary, InsightReviewNote, InsightContextNote, InsightHumanFeedback, InsightTraceTitle, InsightTraceSummary, InsightWorktreeBranch, InsightPRBody:
		return EventInsight
	default:
		return ""
	}
