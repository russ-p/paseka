...
func TestTracesTabStaticContract(t *testing.T) {
	...
	for _, needle := range []string{
		...
		`id="trace-worktree-wrap"`,
		`id="trace-artifacts-wrap"`,
		`id="trace-artifacts-list"`,
		`id="trace-artifacts-preview"`,
		`id="trace-tasks-list"`,
		`id="trace-runs-list"`,
