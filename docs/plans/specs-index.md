...
| [035-queen-console-redesign](../specs/035-queen-console-redesign.md) | Draft | Svelte 5 + Tailwind v4 + DaisyUI rewrite; `/next/` preview coexists with legacy Console until parity cutover |
