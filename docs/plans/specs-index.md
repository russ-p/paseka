...
| [021-provider-session-logs-export](../specs/021-provider-session-logs-export.md) | Draft | AFK Cursor/Pi persist `providerSessionId`; remaining: export Agent log, HITL Cursor resume, `events.ndjson` bus-only cleanup |
