...
| [028-standing-trails](../specs/028-standing-trails.md) | Draft (identity slice shipped) | Long-lived named Flight Trails for recurring cues; sidecar cron; comb checkpoints; per-tick honey stipend |
