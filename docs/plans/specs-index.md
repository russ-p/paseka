...
| [024-pull-request-delivery](../specs/024-pull-request-delivery.md) | Implemented | Isolated trails: opt-in PR publish instead of local merge; bees `pr.body`; forge via external CLI script contract |
...
| [032-queen-console-term-engine](../specs/032-queen-console-term-engine.md) | Implemented | Queen Console session view engine toggle: xterm (stable, default) vs experimental Ghostty WebGPU/WASM, browser-local, async-recreate race guarded |
