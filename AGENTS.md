...
- [docs/architecture/queen-console-design-system.md](docs/architecture/queen-console-design-system.md) — Queen Console UI contract (themes, component inventory, hard rules) — read before writing any console UI.
